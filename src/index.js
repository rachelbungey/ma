...
const App = () => (
  <a-scene background="color: black">
    ...
    <a-light
      ...
      intensity="1"
      light="castShadow: true; shadowCameraNear: -50; shadowCameraTop: 50; shadowCameraRight: 50; shadowCameraLeft: -50; shadowMapWidth: 1024; shadowMapHeight: 1024"
    ></a-light>
    ...
    <a-entity
      ...
      reflective-material=""
      position="10.134 7.24892 -0.18894"
      scale="1.2 1.2 1.2"
    ></a-entity>
    <a-entity
      geometry="primitive: sphere"
      reflective-material=""
      position="28.08098 6.00823 0.77162"
      scale="1.98642 1.98642 1.98642"
    ></a-entity>
    <a-gltf-model
      name="sculpt1"
      src="#sculpt1"
      position="0 0 0"
      set-gltf-material="castShadow: true"
    />
    <a-gltf-model
      name="sculpt2"
      src="#sculpt2"
